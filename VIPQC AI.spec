...
a = Analysis(
    ...
    hiddenimports=['pymupdf', 'fitz', 'openpyxl', 'openpyxl.styles', 'openpyxl.utils', 'et_xmlfile', 'PIL', 'tkinter', 'tkinter.ttk', 'tkinter.filedialog', 'tkinter.messagebox', 'customtkinter', 'windnd', 'bom_comparator', 'bom_extractor', 'excel_exporter', 'model_comparator', 'updater'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
    excludes=[],
